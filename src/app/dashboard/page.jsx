      ...
      <div className="flex-1 p-8">
        ...
        <div className="mt-6 bg-white p-4 rounded-lg shadow-md flex space-x-4">
          <button
            ...
            className={`px-4 py-2 bg-red-500 text-white rounded flex items-center space-x-2 ${selectedUsers.length === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-red-600'
              }`}
          >
            <FaLock />
            <span>Block</span>
          ...
          <button
            ...
            disabled={selectedUsers.length === 0}
            className={`px-4 py-2 bg-green-500 text-white rounded flex items-center space-x-2 ${selectedUsers.length === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-600'
              }`}
          >
            <FaUnlock />
            <span>Unblock</span>
